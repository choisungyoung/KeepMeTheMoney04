...
//        gridView.addView(imgprdtAdapter.getView());
    ...
    public void initializeData(String ages) {
        ...
        switch (ages) {
            case "20대 이하":
                imageList.add(new Pair("향수", R.drawable.perfume, 100000000));
                imageList.add(new Pair("스마트폰", R.drawable.phone, 1000000));
                imageList.add(new Pair("노트북", R.drawable.laptop, 1500000));
                imageList.add(new Pair("무선게임기", R.drawable.game, 1500000));
                ...
                imageList.add(new Pair("신발", R.drawable.shoe, 500000));
                imageList.add(new Pair("자전거", R.drawable.bicycle, 500000));
                imageList.add(new Pair("전동킥보드", R.drawable.kickboard, 500000));
                imageList.add(new Pair("이륜차", R.drawable.motorcycle, 500000));
                imageList.add(new Pair("시계", R.drawable.watch, 100000000));
                imageList.add(new Pair("지갑", R.drawable.wallet, 100000000));
            ...
            case "30대":
                ...
                imageList.add(new Pair("가전제품", R.drawable.electric, 200000000));
                imageList.add(new Pair("가구", R.drawable.sofa, 200000000));
            ...
            case "60대 이상":
                ...
                imageList.add(new Pair("건물", R.drawable.building, 200000000));break;
        }
    }
}
